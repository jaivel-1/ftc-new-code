...
@Autonomous(name="Red Frontstage", group="Robot")
//@Disabled
public class New_Red_Frontstage extends LinearOpMode
{
    // List of Variables:
    long sleeptime = 100;
    ...
    public void runOpMode()
    {
        ...
        MecanumRobotUtilities.InitializeHardware(New_Red_Frontstage.this);
        ArmRobotUtilities.InitializeArm(New_Red_Frontstage.this);
        ...
        InitializeCamera(New_Red_Frontstage.this);
        SetPipeline();

        waitForStart();
        startCamera(New_Red_Frontstage.this);
        ...
        while (opModeIsActive())
        {
            ...
            else
            {
                ...
                // Spin Clockwise:
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.SPINCLOCKWISE, driveSpeed,
                ...
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.BACKWARD, driveSpeed,
                                Path_Constants.FSR_WP_Right[10], 10.0,
                                New_Red_Frontstage.this);
                sleep(sleeptime);
                // Strafe Left:
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.LEFT, driveSpeed,
                                Path_Constants.FSR_WP_Right[11], 10.0,
                                New_Red_Frontstage.this);
                sleep(sleeptime);
                // Raise Arm:
                ArmRobotUtilities.encoderArm(ArmRobotUtilities.armSpeed * 2,
