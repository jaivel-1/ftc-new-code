...
@Autonomous(name="Blue Frontstage", group="Robot")
//@Disabled
public class New_Blue_Frontstage extends LinearOpMode
{
    // List of Variables:
    long sleeptime = 100;
    ...
    public void runOpMode()
    {
        ...
        MecanumRobotUtilities.InitializeHardware(New_Blue_Frontstage.this);
        ArmRobotUtilities.InitializeArm(New_Blue_Frontstage.this);
        ...
        InitializeCamera(New_Blue_Frontstage.this);
        SetPipeline();

        waitForStart();
        startCamera(New_Blue_Frontstage.this);
